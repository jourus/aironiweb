...
while ( $row = $result->fetch_assoc () ) {
	...
	echo tableRow ( " class=\"" . $formatClasseRiga . "\"", array (
			$Podio,
			$classe,
			$categoria,
			$Classifica 
	...
	<div id="speciali">
		<table id="comandispeciali">
			...
			<tr>
				...
				<td><div align="center">
						<a href="#"
							onClick="MM_openBrWindow('contenitore.htm','onda','menubar=yes,width=800,height=600')"><img
							src="immagini/computer.gif" width="14" height="14"></a>
					</div></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><div align="center">
						<a href="#"
							onClick="MM_openBrWindow('benvenuti.html','onda','toolbar=yes,width=800,height=600')"><img
							src="immagini/computer.gif" width="14" height="14"></a>
					</div></td>
			</tr>
			<tr>
